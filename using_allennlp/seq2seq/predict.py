...
@Predictor.register('simple_seq2seq_predictor', exist_ok=True)
class simple_seq2seq_predictor(Predictor):
    ...
    def predict_line(self, line: str):
        ...
        return {'input': line, 'predict_title': "".join(ouput_dict['predicted_tokens'])}
...
if __name__ == '__main__':
    ...
    predictor = Predictor.from_archive(archive, 'simple_seq2seq_predictor',
                                  dataset_reader_to_load = "simple_seq2seq_reader")
    ...
    with open('/home/liangjiaxi/TMP_PROJECT/pingan_event_extraction/using_allennlp/data/pkuseg_0_7_test.json') as f:
        data = json.load(f)
    for dct in data:
        ...
        print('*'*50)
        print(title)
        print(predictor.predict_line(abstract))